...
<!-- Ability - A Responsive One Page AJAX Wordpress Theme designed and coded by Ed Cousins | www.swiftpsd.com / www.edcousins.com -->
	...
	<!-- OPEN head -->
	<head>
		<title>My Goodness Gracious | Macrobiotic, Plant Based, & Vegan Recipes for body, mind and spirit</title>
		<?php global $data; ?>
				...
				<header class="sixteen columns">
					...
					<div class="nav-wrap nine columns omega">
						...
						<nav id="main-navigation">
							...
							<?php
							include_once 'class.description_walker.php';
				...
				<div id="drawer-content">
					<div style="background:#6e75b6;padding:10px" class="newsletter">
	                    <div style="border:1px #fff solid; padding:10px">
                            ...
                            <p>A publication delivered directly to your inbox offering healthy recipes & wellness tips.</p>
                            ...
                            <div id="mc_embed_signup">
                                ...
                                <input type="text" value="" name="MMERGE1" class="required" placeholder="your first name" id="mce-MMERGE1">
