<?php
/*
Plugin Name: Post Re-Order
Plugin URI: http://labs.arraysoftlab.com/post-re-order
Description: Posts Order and Post Types Objects Order using just Drag and Drop
Author: arraysoftlab
...
/*
define('CPTPATH',   WP_PLUGIN_DIR  .'/post-re-order');
define('CPTURL',    WP_PLUGIN_URL .'/post-re-order'); 
*/
                ...
                foreach( $post_types as $post_type_name ) 
                    {
                        ...
                        if ($post_type_name == 'post')
                            add_submenu_page('edit.php', 'Edit Order', 'Edit Order', $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                        else
                            {
                                if (!is_post_type_hierarchical($post_type_name))
                                    add_submenu_page('edit.php?post_type='.$post_type_name, 'Edit Order', 'Edit Order', $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                            }
		            }
	        }
